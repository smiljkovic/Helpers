...
#cp -f $ROOT/dnake/bin/reset /dnake/cfg/
#chmod -R 0777 /dnake/cfg/reset
...
#mkdir /product/usr/
#cp -f $ROOT/product/app_sd/chrome.apk /product/usr/
#chmod 0644 /product/usr/chrome.apk
mount -o remount,rw /
